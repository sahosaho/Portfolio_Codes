...
public class Player : MonoBehaviour
{
    ...
    private void Start()
    {
        startGame = true;
        isDead = false;
        //enemyAi_Script = GameObject.Find("Enemy").GetComponent<EnemyAi>();
        canRun = true;
    ...
    private void Update()
    {
       ...
       // trail.transform.position = trailHolder.position;
    ...
    public void Won()
    {
      ...
      startGame = false;
        ...
        //GetComponent<Animation>()["Bboy Hip Hop Move"]. wrapMode = WrapMode. Loop;  
        lineRenderer.enabled = false;
        trail.enabled = false;
    }
